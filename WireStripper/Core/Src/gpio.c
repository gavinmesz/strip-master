...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, GPIO_PIN_0|OLED_DC_Pin|OLED_RST_Pin|BUCK5_EN_Pin
                          |M2_SLP_Pin|M1_SLP_Pin|M1_EN_Pin, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|BUCK12_EN_Pin|M2_DIR_Pin|LD3_Pin
                          |LA_IN1_Pin|DISP_RST_Pin|DISP_DC_Pin|LD2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, M1_MS2_Pin|M1_MS1_Pin|GPIO_PIN_6|DISP_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LA_MODE_GPIO_Port, LA_MODE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PF0 OLED_DC_Pin OLED_RST_Pin BUCK5_EN_Pin
                           M2_SLP_Pin M1_SLP_Pin M1_EN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0|OLED_DC_Pin|OLED_RST_Pin|BUCK5_EN_Pin
                          |M2_SLP_Pin|M1_SLP_Pin|M1_EN_Pin;
  ...
  /*Configure GPIO pins : LD1_Pin BUCK12_EN_Pin M2_DIR_Pin LD3_Pin
                           LA_IN1_Pin DISP_RST_Pin DISP_DC_Pin LD2_Pin */
  ...
  /*Configure GPIO pin : BUCK5_PG_Pin */
  GPIO_InitStruct.Pin = BUCK5_PG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BUCK5_PG_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : M1_MS2_Pin M1_MS1_Pin PG6 DISP_CS_Pin */
  GPIO_InitStruct.Pin = M1_MS2_Pin|M1_MS1_Pin|GPIO_PIN_6|DISP_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : LA_MODE_Pin */
  GPIO_InitStruct.Pin = LA_MODE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LA_MODE_GPIO_Port, &GPIO_InitStruct);
