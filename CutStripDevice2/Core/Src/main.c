...
int main(void)
{
  ...
  TIM1->ARR = 999; //Period is 999us
  TIM1->CCR1 = 20; //duty cycle is 20%
  /* USER CODE END Init */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : BMS_ALERT_Pin BUCK12_PG_Pin */
  ...
  /*Configure GPIO pins : BUCK5_EN_Pin M2_DIR_Pin */
  ...
  /*Configure GPIO pins : PC4 M2_EN_Pin M2_MS2_Pin M2_MS1_Pin
  ...
  /*Configure GPIO pins : BUCK12_EN_Pin OLED_DC_Pin LDO_EN_Pin OLED_CS_Pin
